            ...
            <div id="big">
                <div class="container">
                    <form @submit.prevent="register()">
                        ...
                        <br>
                        <div class="input-form">
                            <input v-model="registerUser.username" required>
                            <div class="underline"></div>
                            <label><i class="fa-regular fa-address-card"></i> Username</label>
                        </div>
                        ...
                        <div class="input-form">
                            ...
                            <div class="underline"></div><label><i class="fa-solid fa-lock"></i> Password
                                Confirmation</label>
                        </div>
                        ...
                        <br>
                        <br>
                        <router-link :to="{ name: 'UserLogin' }" class="under"
                            style="text-decoration: none;color: var(--user-color);"> You have an account, Sign up
                            here.</router-link><br>
...
export default {
    ...
    mounted() {
        ...
        window.document.title = 'Register | Blog';
