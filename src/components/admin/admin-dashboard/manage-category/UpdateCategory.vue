<template>
    <div id="update-category">
        <div class="modal fade" ref="updateCategoryRef" id="updateCategory" tabindex="-1" role="dialog"
                ...
                <form @submit.prevent="updateCategory()">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input v-model="category.name" type="text" class="mb-1 form-control" placeholder="Title" />
                            <textarea v-model="category.description_category" class="mb-1 form-control" placeholder="Description"
                                rows="3"></textarea>
                            <input v-model="category.search_number" type="number" min="0" value="0"
                                class="mb-1 form-control" placeholder="Search Number">
                            <!-- <input ref="fileInput" @change="handleFileUpload" type="file" accept="image/*"
                                class="mb-1 form-control-file" placeholder="Upload Image">
...
export default {
    ...
    mounted() {
        onEvent('eventSelectCategory', (category) => {
            ...
            this.previewImageSrc = this.category.thumbnail;
    ...
    methods: {
        ...
        updateCategory: async function () {
            try {
                ...
                const { data, messages } = await AdminRequest.post(`category/update/${this.category.id}`, formData, true);
                console.log(data);
