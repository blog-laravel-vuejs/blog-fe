                            ...
                            <div class="modal-body">
                                <form @submit.prevent="addUser()">
                                    <div class="input-form">
                                        <input required id="inputPassword" type="text" v-model="user.name">
                                    ...
                                    <br>
                                    <div class="input-form">
                                        <input required id="inputPassword" type="text" v-model="user.email">
                                    ...
                                    <br>
                                    <div class="input-form">
                                        <input required id="inputPassword" type="text" v-model="user.username">
                                        <div class="underline"></div><label><i class="fa-solid fa-signature"></i> UserName</label>
                                    </div>
                                    <span v-if="errors.name" class="text-danger">{{ errors.username[0] }}<br></span>
                                    <br>
...
export default {
    ...
    methods: {
        addUser: async function () {
            try {
                const { messages } = await AdminRequest.post('admin/add-user', this.user, true);
                emitEvent('eventSuccess', messages[0]);
                for (let key in this.errors) this.errors[key] = null;
                var closePW = window.document.getElementById('addUser');
                closePW.click();
                this.user = {
                    name: null,
                    email: null,
                ...
                emitEvent('eventRegetUsers', ''); // reget data 
            }
            catch (error) {
